<div class="inner-blocks" id="counter">
          <div class="statistics-block">
            <img src="{{Imageick::readImageFile(Voyager::image($data -> image_coworkers))}}" alt="" class="statistics-icon" />
          ...
          <div class="statistics-block">
            <img src="{{Imageick::readImageFile(Voyager::image($data -> image_users))}}" alt="" class="statistics-icon" />
            <div class="statistics-data">
          ...
          <div class="statistics-block">
            <img
              src="{{Imageick::readImageFile(Voyager::image($data -> image_staff))}}"
              alt=""
